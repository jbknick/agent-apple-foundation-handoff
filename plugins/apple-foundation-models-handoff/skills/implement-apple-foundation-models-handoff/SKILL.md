...
and in the listed order. Populate every nested field; do not replace that shape with
YAML or JSON. Use only the four pattern enum values shown above. Render source and
