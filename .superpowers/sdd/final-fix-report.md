...
- Command operands reject option-like path values. All operand, field, source,
  root, ancestor, parent, target, and captured-absence identities survive the
  bridge boundary and are rechecked before application.
...
- Placeholder search was empty, validator/schema signatures agree through the
  full 401-test suite, generated artifacts are synchronized, and the proof is
